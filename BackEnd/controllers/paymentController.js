...
exports.createRedirectPayment = async (req, res) => {
    ...
    try {
        ...
        // 1) Tạo USER_SUBSCRIPTION pending
        const now = new Date();
      ...
      `);
        ...
        if (!payRes.checkoutUrl) throw new Error('No checkoutUrl');
      ...
      `);
        ...
        return res.json({ success: true, checkoutUrl: payRes.checkoutUrl, orderCode });
    } catch (err) {
