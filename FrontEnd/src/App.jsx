...
import { Card, Typography, Space, Button, ConfigProvider, App as AntdApp } from "antd"; 
...
function App() {
  return (
    <ConfigProvider> {/* ✅ Wrap với ConfigProvider */}
      <AntdApp> {/* ✅ Wrap với AntdApp để message hoạt động */}
        <AuthProvider>
          <SocketProvider>
            <Router>
              <Routes>
