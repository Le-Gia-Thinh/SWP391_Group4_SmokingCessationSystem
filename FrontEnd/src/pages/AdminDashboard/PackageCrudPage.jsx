...
export default function PackageCrudPage() {
    ...
    const fetch = async () => {
        try {
            const res = await axios.get(`${baseURL}/api/subscriptions/packages`, { headers });
            setData(res.data);
        } catch {
        ...
        <>
            ...
            <Table
                ...
                columns={[
                    ...
                    {
                        title: "Giá (đ)", dataIndex: "price", key: "price",
                        render: v => Number(v).toLocaleString(undefined, { minimumFractionDigits: 2 })
                    },
                    { title: "Thời hạn (ngày)", dataIndex: "duration_days", key: "duration_days" },
                    {
                        title: "Coach", dataIndex: "coach_access", key: "coach_access",
                        render: v => v ? "✔️" : "❌"
                    },
                    {
                        title: "Community", dataIndex: "community_access", key: "community_access",
                        render: v => v ? "✔️" : "❌"
                    },
                    {
                        title: "Premium", dataIndex: "premium_content", key: "premium_content",
                        render: v => v ? "✔️" : "❌"
                    },
                                ...
                                <Popconfirm
                                    ...
                                    onConfirm={() => {
                                        axios.delete(
                                            ...
                                            .then(() => { message.success("Xóa thành công"); fetch(); })
            ...
            <Modal
                ...
                onCancel={() => { setModal({ visible: false, record: null }); form.resetFields(); }}
