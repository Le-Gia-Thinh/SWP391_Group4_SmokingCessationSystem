    ...
    { title: "Loại", dataIndex: "achievement_type" },
    {
      ...
      render: (_, record) => (
        <Space>
          <Button
            size="small"
            className="achievement-btn achievement-btn-edit"
          ...
          >
            <Button
              size="small"
              className="achievement-btn achievement-btn-delete"
            >
              Xóa
            </Button>
          </Popconfirm>
  ...
  return (
    <Card
      ...
      extra={
        <Button
          type="primary"
          className="achievement-add-btn achievement-btn"
    ...
    >
      <div className="achievement-table-wrapper">
        <Table
          ...
          className="achievement-table admin-dashboard-table"
        />
      </div>
