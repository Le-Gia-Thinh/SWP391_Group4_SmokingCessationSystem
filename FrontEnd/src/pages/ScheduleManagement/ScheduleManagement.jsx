      ...
      if (scheduleType === "single") {
        ...
        requestData = {
          ...
          pattern: values.usePattern
            ...
            : null,
          schedules: values.usePattern
            ? null
            : values.specificSchedules
            ? values.specificSchedules.split("\n").map((line) => {
        ...
        const data = await handleResponse(response);
        message.success(
          `Đã tạo thành công ${data.createdCount} lịch cho coach`
        );
      } else {
        // Multiple coaches
        requestData = {
        ...
        const data = await handleResponse(response);
        message.success(
          `Đã tạo thành công ${data.totalCreated} lịch cho ${data.coachCount} coach`
        );
      }
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        ...
        />
        {/* Center content below the table */}
        <div
          style={{
            display: "flex",
        ...
        >
          {/* Place any content you want centered below the table here */}
        </div>
      </Card>
        ...
        >
          ...
          {scheduleType === "multiple" && (
            <Form.Item
              ...
              rules={[
                { required: true, message: "Vui lòng chọn ít nhất 1 coach" },
              ]}
            >
              <Select
                mode="multiple"
          ...
          <Form.Item
            ...
            shouldUpdate={(prevValues, currentValues) =>
              prevValues.usePattern !== currentValues.usePattern
            }
          >
            {({ getFieldValue }) => {
              ...
              if (usePattern) {
                      ...
                      <Col span={12}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Vui lòng chọn phạm vi ngày",
                            },
                          ]}
                        >
                      ...
                      <Col span={12}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Vui lòng chọn phạm vi giờ",
                            },
                          ]}
                        >
                ...
                return (
                  <Form.Item
                    ...
                    label="Lịch cụ thể"
                    rules={[
                      { required: true, message: "Vui lòng nhập lịch cụ thể" },
                    ]}
                  >
                    <Input.TextArea
                      rows={4}
          ...
          <Form.Item>
            <Space>
              <Button onClick={handleScheduleCancel}>Hủy</Button>
              <Button
                type="primary"
                htmlType="submit"
